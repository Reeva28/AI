...
# 4c) Steepest-Ascent Hill Climbing
def steepest_ascent_hill_climbing(dist, start_tour):
    current = start_tour
...
if __name__ == "__main__":
    ...
    tour, cost, hist = steepest_ascent_hill_climbing(dist, start.copy())
    print("\nSteepest-Ascent HC → tour:", tour, "cost =", cost)
